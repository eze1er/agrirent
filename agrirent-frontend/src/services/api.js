...
export const paymentAPI = {
  ...
  requestWithdrawal: (data) => api.post("/payments/owner/request-withdrawal", data),
  ...
  getDisputeDetails: (disputeId) => api.get(`/payments/admin/disputes/${disputeId}`),
  ...
  getPendingVerifications: () => api.get("/payments/admin/pending-verifications"),
...
export const userAPI = {
  ...
  updatePaymentPreferences: (data) => api.put("/users/payment-preferences", data),
  getPaymentMethods: () => api.get("/users/payment-methods"),
  addPaymentMethod: (data) => api.post("/users/payment-methods", data),
  removePaymentMethod: (methodId) => api.delete(`/users/payment-methods/${methodId}`),
  setDefaultPaymentMethod: (methodId) => api.patch(`/users/payment-methods/${methodId}/default`),
...
export const analyticsAPI = {
  ...
  getEarningsReport: (period) => api.get(`/analytics/earnings?period=${period}`),
  getRentalAnalytics: (period) => api.get(`/analytics/rentals?period=${period}`),
  getMachinePerformance: (machineId) => api.get(`/analytics/machines/${machineId}/performance`),
  getPaymentAnalytics: (period) => api.get(`/analytics/payments?period=${period}`),
};
